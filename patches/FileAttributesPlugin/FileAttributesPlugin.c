/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.2257 uuid: 7a3c75a8-72e7-4362-88b7-9a97109592a1
   from
	FileAttributesPlugin FileAttributesPlugin-AlistairGrant.13 uuid: 2a8819f0-cda3-45bd-b95b-083995f443a7
 */
static char __buildInfo[] = "FileAttributesPlugin FileAttributesPlugin-AlistairGrant.13 uuid: 2a8819f0-cda3-45bd-b95b-083995f443a7 " __DATE__ ;
...
static usqInt (*positive32BitIntegerFor)(unsigned int integerValue);
...
extern usqInt positive32BitIntegerFor(unsigned int integerValue);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FileAttributesPlugin FileAttributesPlugin-AlistairGrant.13 (i)"
#else
	"FileAttributesPlugin FileAttributesPlugin-AlistairGrant.13 (e)"
#endif
;
...
#if !defined(WIN32)
	storePointerofObjectwithValue(1, masks, smallOrLargeIntegerObjectFor(S_IFSOCK));
...
statArrayFortoArrayfromfileName(char *cPathName, sqInt attributeArray, struct stat *statBufPointer, sqInt fileNameOop)
{
	...
	if (status == 0) {
		...
		storePointerofObjectwithValue(index, attributeArray, nilObject());
	}
