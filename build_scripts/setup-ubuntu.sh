...
apt-get install -y libasound2-dev libssl-dev libfreetype6-dev libx11-dev libxext-dev gcc-multilib uuid-dev libssh2-1-dev libgl1-mesa-dev libpulse-dev:i386 libglib2.0-dev:i386 unzip zip
